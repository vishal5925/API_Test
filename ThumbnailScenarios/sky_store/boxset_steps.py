...
def put_create_new_single_season_box_set_using_boxset_apis(message_body):
    ...
    api_response = api_utils.put(boxset_create_url, json_body=message_body, token=BOXSET_TOKEN)
    return api_response
...
def post_boxset_episode_acquisitions(deal_type):
    request = {"Aggregators": [{"AggregatorCode": "BOXEST", "PlatformType": "BE"},
               ...
               "NumberOfParts": 1,
               "DealType": deal_type,
               "HDProviderId": constants.BoxsetEpisodeDealType.get_provider_id(deal_type)
               }

    return api_utils.post(app_urls.ACQUISITIONS, token_string=None, json_body=request)
...
def create_boxset_message_body(boxset_type, season_type=constants.BoxsetSeasonType.Single_Season, season_no=None,
    ...
    request = {
        ...
        "Deal": {
            ...
            "MediumName": "testing boxset",
            "LongName": "testing boxset",
            "StudioReferenceId": "",
            "EIDR": "",
